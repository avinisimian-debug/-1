...
const en: Translations = {
  ...
  pdfTagline: "Executive meeting closeout",
  ...
  historyEmpty: "No meetings saved yet. Close your first meeting to see it here.",
  historyView: "View",
  ...
  gateEyebrow: "Included with Pro",
  gateStartTrial: "Continue with Pro",
  gateNotNow: "Not now",
...
const he: Translations = {
  ...
  pdfTagline: "סגירת פגישה למנהלים",
  ...
  historyEmpty: "עדיין אין פגישות שמורות. סגרו פגישה ראשונה כדי לראות אותה כאן.",
  historyView: "צפייה",
  historyDelete: "מחק",
  ...
  gateEyebrow: "כלול ב-Pro",
  gateStartTrial: "המשיכו עם Pro",
  gateNotNow: "לא עכשיו",

...
const en: Translations = {
  ...
  saleTitle: "Launch week: Pro free now — then {intro}/mo, then {regular}/mo",
  saleFirstMonth: "Free until launch week ends — then {intro}, then {regular}/mo",
  saleFreeWeek: "Free this week",
  salePricingNote: "After launch week: {intro}/mo (1st month), then {regular}/mo every month.",
...
const he: Translations = {
  ...
  saleBadge: "שבוע השקה",
  saleTitle: "שבוע השקה: Pro בחינם עכשיו — ואז {intro}/חודש, ואז {regular}/חודש",
  saleFirstMonth: "חינם עד סוף שבוע ההשקה — אחר כך {intro}, ומחודש שני {regular}/חודש",
  saleFreeWeek: "חינם השבוע",
  salePricingNote: "אחרי שבוע ההשקה: {intro}/חודש (חודש ראשון), ואז {regular}/חודש כל חודש.",

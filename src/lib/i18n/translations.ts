...
const en: Translations = {
  ...
  landingPricingTitle: "One Pro offer. Easy to explain.",
  landingPricingFreeTitle: "Free — reach the aha",
  landingPricingProTitle: "Pro — meeting memory",
  landingPricingFree1: "A few meetings each month to learn the closeout",
  landingPricingFree2: "Brief, decisions, actions, and copy to send",
  landingPricingPro1: "Cloud library that follows you to every device",
  landingPricingPro2: "Higher capacity for real working weeks",
  landingPricingPro3: "Professional PDF and retained recordings",
  ...
  gateQuotaLine2: "Staz Pro is $24.90/month: more meetings, cloud memory, professional send.",
  gatePdfTitle: "Professional executive PDF",
  gatePdfLine1: "Copy the brief for free. PDF is the sendable artifact for clients.",
  gatePdfLine2: "Included with Staz Pro at $24.90/month.",
  ...
  liveHubDesc:
    "Schedule Zoom, Meet, or Teams meetings with timezone-aware bot auto-join, cloud recording ingest, and AI digests.",
...
const he: Translations = {
  ...
  landingPricingTitle: "הצעה אחת. אפשר להסביר במשפט.",
  landingPricingFreeTitle: "חינמי — להגיע לאהה",
  landingPricingProTitle: "Pro — זיכרון הפגישות",
  landingPricingFree1: "מספר פגישות בחודש כדי להבין את הסגירה",
  landingPricingFree2: "תמצית, החלטות, משימות והעתקה לצוות",
  landingPricingPro1: "ספריית ענן שעוברת איתכם בין מכשירים",
  landingPricingPro2: "יותר נפח לשבוע עבודה אמיתי",
  landingPricingPro3: "PDF מקצועי והקלטות שנשמרות",
  landingPricingEnterprise: "",
  ...
  gateQuotaLine2: "Staz Pro הוא $24.90 לחודש: יותר פגישות, ספריית ענן, שליחה מקצועית.",
  gatePdfTitle: "PDF מנהלים מקצועי",
  gatePdfLine1: "העתקת הסיכום נשארת בחינם. PDF הוא מה ששולחים ללקוח.",
  gatePdfLine2: "כלול ב-Staz Pro ב-$24.90 לחודש.",
  ...
  liveHubDesc:
    "תזמון פגישות Zoom, Meet או Teams עם בוט אוטומטי לפי אזור זמן, העלאת הקלטה וסיכום AI.",
